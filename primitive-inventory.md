...
| `Nat.sub` | `Init/Prelude.lean:2075` says the function is overridden in the kernel and compiler.  The declaration has `@[extern "lean_nat_sub", implicit_reducible]`. | Implemented as a specified primitive reduction. |
