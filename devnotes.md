...
| Local Lean 4.27.0 sources, `Lean/Declaration.lean`, `Lean/Environment.lean`, and `Lean/Replay.lean` | Reviewed for exported declaration shape.  Lean replays axioms, definitions, theorems, opaque definitions, quotient declarations, and inductive declarations into the kernel, while checking generated constructors and recursors against the replay result. |
