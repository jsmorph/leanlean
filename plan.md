...
- [ ] Phase 14: Complete replay checker boundary.
  ...
  - [ ] Add a replay gap report over safe, non-partial declarations in `lean4export` artifacts and loaded `ConstantInfo` maps.
